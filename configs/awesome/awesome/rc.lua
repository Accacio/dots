...
globalkeys = gears.table.join(
    ...
    -- Standard program
    awful.key({ modkey, "Shift"          }, "e", function () awful.spawn("powerMenu") end,
    ...
    -- -- Menubar
    awful.key({ modkey }, "x", function() awful.spawn("rofi -show drun -theme menu -show-icons -threads 0") end,
              {description = "Open Programs", group = "launcher"}),
