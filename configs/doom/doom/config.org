...
(after! bibtex
  (setq bibtex-completion-bibliography '(
                                         ...
                                         ("~/research/thermique_batiment/bibliography/bibliography.bib")
                                         ("~/research/robotique/bibliography/bibliography.bib"))
        bibtex-completion-library-path '(
                                         ("~/research/bibliography/")
                                         ("~/research/thermique_batiment/bibliography/files/")
                                         ("~/research/robotique/bibliography/files/"))
...
(after! deft
  ...
  (setq deft-directory (file-truename "~/research/notes/")
        ...
        deft-strip-summary-regexp (concat "\\(?:"
          ...
          "\\|^:PROPERTIES:\n\\(.+\n\\)+:END:\n" ; org-mode title
          "\\|^#\\+\\(TITLE\\|title\\): .*" ; org-mode title
          "\\|^#\\+\\(filetags\\): .*" ; org-mode filetags
          "\\|^- \\(tags\\|keywords\\) .*" ; org-mode tags and keywords
          "\\|-\\*-[[:print:]]+-\\*-" ; -*- .. -*- lines
          "\\|^\\(Title\\|title\\):[\t ]*" ; MultiMarkdown metadata
          "\\|#+" ; line with just # chars
          "$\\)")
          deft-separator " \t| "
        )
...
(after! org
  ...
  (setq org-agenda-custom-commands
        '(
          ...
          ("ch" "home" tags-todo "@home"
           ...
           ("ct" "train" tags-todo "@train"
           ((org-agenda-overriding-header "Train")))
          ))
  ...
  (setq org-todo-keyword-faces '(
                                 ...
                                 ("QUESTIONS" . magit-signature-error)
